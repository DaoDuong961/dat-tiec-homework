...
function FormInfo() {
  ...
  return (
    <div className="form">
      ...
      <p>
        Kế thừa tinh hoa của Golden Gate Restaurant chúng tôi cung cấp giải pháp
        dịch vụ tiệc tại gia đạt chuẩn chất lượng nhà hàng giúp khách hàng
      </p>
      ...
      <br />
      <button type="submit" onClick={(e) => submibForm(e)}>
        Gửi thông tin ngay
      </button>
    </div>
  );
